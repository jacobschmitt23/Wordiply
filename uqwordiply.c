...
//Does this leak that one spot in memory where the '\0' used to be??? I don't
//think so bc strings just go forever until they find a \0 so how would it
//know where its old end was
/* trim_new_line()
 * ----------------
